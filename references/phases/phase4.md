...
1. **DQA 檢討報告**：PM 必須強迫 DQA 針對漏掉該 Bug 的失誤，撰寫一份 `DQA_Reflection_Report.md`，並存入 `Logs/lesson_learnt_registry.md` 中。
2. **重返 Phase 3**：PM 立即更新 PRD 或 Test Plan，帶領團隊退回 Phase 3 重新修復並審查。
